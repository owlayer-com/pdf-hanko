...
## 簡易デモ : Quick Demo
<video src="https://github.com/user-attachments/assets/77195477-633d-4aac-ba99-8a5c70ace9e9" controls></video>
...
- **マイナンバーカード署名**: 証明書として PKCS#12 ファイルの代わりにマイナンバーカード（公的個人認証 / JPKI の署名用電子証明書）を利用可能。秘密鍵はカードから取り出されず、署名処理はカード内で実行されます
...
- 署名用パスワード（券面入力補助用ではなく、6〜16 桁の英数字の方）
